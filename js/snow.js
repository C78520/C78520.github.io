...
function snowFall(snow) {
    /* ���������� */
    snow = snow || {};
    this.maxFlake = snow.maxFlake || 150; /* ���Ƭ�� */
...
function snowCanvas() {
    ...
    snowcanvas.width = window.innerWidth*0.98;
	pageheader_height = document.getElementById('page-header').offsetHeight;
    snowcanvas.height = pageheader_height;
...
flakeMove.prototype.update = function () {
    ...
    this.x += this.velX;
    /* �ɳ��߽�Ĵ��� */
    if (this.x >= canvas.width || this.x <= 0 || this.y >= screen.height || this.y <= 0) {
